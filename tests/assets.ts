...
/*
 * Файлы, которым в игре нет соответствия и не будет: черновики прошлых поставок
 * арта и картинки отмененных решений. Держим их списком, чтобы эвристика опечаток
 * срабатывала на действительно новых файлах, а не на этих при каждом новом типе.
 *
 * `system_*` — миниатюры для отмененной идеи «своя картинка на класс светила»;
