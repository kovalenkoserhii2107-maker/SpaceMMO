...
if (!token) {
   ...
   * пятую часть своей вместимости — 700 своего ресурса, а не 2 100 общих.
   * Двенадцать тысяч руды прикрыты только рудным хранилищем, и пустой
   * плазменный склад свою защиту им не одалживает — в этом смысл разделения.
   */
  check(
    'добыча считается по механике сейфа',
    plunder && plunder.protectedAmount === 1400 && plunder.surplus === 18600,
