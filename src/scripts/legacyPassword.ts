/**
 * Выдача пароля легаси-аккаунту (Этап 8).
 *
 * Аккаунты Фаз 1-2 мигрировали без пароля: у них служебный email вида
 * <id>@legacy.local и пустой passwordHash. Скрипт задает им пароль и, при
 * желании, нормальный email — чтобы старыми командирами можно было играть.
 *
