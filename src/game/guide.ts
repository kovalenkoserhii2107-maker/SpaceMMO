    ...
    },
    {
      ...
      blocks: [
        list(
          ...
          '«Карта системы» и «Карта галактики» — выбор цели и отправка флота. Нажми на планету, станцию или врата — откроется карточка цели и форма отправки: на компьютере справа от карты, на телефоне под ней.',
