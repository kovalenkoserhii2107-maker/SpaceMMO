...
export const BOT_PERSONALITIES: Record<BotCharacter, BotPersonality> = {
  AGGRESSOR: {
    label: 'Агрессор',
    description:
      'Цель — занять весь космос. Экспансия любой ценой: колонизирует все свободное ' +
      'в радиусе, вкладывает доход во флот и объявляет войны.',
    /*
     ...
     */
    budget: { economy: 0.4, research: 0.2, fleet: 0.35, defense: 0.05 },
